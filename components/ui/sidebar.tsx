...
export const DesktopSidebar = ({
  ...
  return (
    <>
      <motion.div
        className={cn(
          "h-full px-3.5 py-4 hidden  md:flex md:flex-col bg-black w-[300px] shrink-0",
          className
        )}
        animate={{
...
export const SidebarLink = ({
  ...
  return (
    <a
      href={link.href}
      className={cn(
        `flex items-center justify-start gap-2 p-1 rounded-2xl group/sidebar py-2 
        ${isActive 
                                ? 'bg-gradient-to-r from-indigo-500/60 to-red-600/60 text-blue-300' 
